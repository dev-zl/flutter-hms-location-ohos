...
class _GeofenceScreenState extends State<GeofenceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(localizations.geofenceScreen),
      ),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Center(
                  child: Column(
                    children: <Widget>[
                      Text('${localizations.geofences}: $_fenceCount'),
                  ...
                  children: <Widget>[
                    Flexible(
                      ...
                      child: CustomTextInput(
                        ...
                        labelText: localizations.geofenceUniqueId,
                    ...
                    Flexible(
                      ...
                      child: SizedBox(
                        height: 45,
                        child: Btn(localizations.removeGeofence, _removeGeofence),
                      ),
                    ),
                  ],
                ),
                ...
                Btn(localizations.createGeofenceList, _createGeofenceList),
                Btn(localizations.deleteGeofenceList, _deleteGeofenceList),
                Btn(localizations.deleteGeofenceListWithIds, _deleteGeofenceListWithIds),
                Text(_bottomText),
              ],
            ),
          ),
