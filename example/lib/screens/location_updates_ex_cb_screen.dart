...
class LocationUpdatesExCbScreen extends StatefulWidget {
  ...
  const LocationUpdatesExCbScreen({Key? key}) : super(key: key);

  @override
  State<LocationUpdatesExCbScreen> createState() =>
...
class _LocationUpdatesExCbScreenState extends State<LocationUpdatesExCbScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(localizations.locationUpdatesExWithCb),
      ),
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Btn(
              localizations.requestLocationUpdates,
              _requestLocationUpdatesExCb,
            ),
            Btn(localizations.removeLocationUpdates, _removeLocationUpdatesExCb),
            Expanded(
