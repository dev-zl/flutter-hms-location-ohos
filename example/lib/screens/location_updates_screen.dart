...
class _LocationUpdatesScreenState extends State<LocationUpdatesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(localizations.locationUpdatesScreen),
      ),
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Btn(localizations.requestLocationUpdates, _requestLocationUpdates),
            Btn(localizations.removeLocationUpdates, _removeLocationUpdates),
            Expanded(
