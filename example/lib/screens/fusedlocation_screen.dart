...
// TODO: Please implement your own 'Permission Handler'.
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(localizations.fusedLocationService),
      ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Btn(localizations.initFusedLocation, _initFusedLocationService),
                  Btn(localizations.checkLocationSettings, _checkLocationSettings),
                  CRow(
                    children: <Widget>[
                      Btn(localizations.getLastLocation, _getLastLocation),
                      Btn(
                        localizations.getLastLocationWithAddress,
                  ...
                  CRow(
                    children: <Widget>[
                      Btn(localizations.getLocationAvailability, _getLocationAvailability),
                      Btn(localizations.setMockModeTrue, _setMockModeTrue)
                    ],
                  ),
                  CRow(
                    children: <Widget>[
                      Btn(localizations.setMockModeFalse, _setMockModeFalse),
                      Btn(localizations.setMockLocation, _setMockLocation)
                    ],
                  ),
                  Btn(localizations.locationUpdates, () {
                    Navigator.pushNamed(
                      context,
                      LocationUpdatesScreen.ROUTE_NAME,
                    );
                  }),
                  Btn(localizations.locationUpdatesWithCallback, () {
                    Navigator.pushNamed(
                      context,
                      LocationUpdatesCbScreen.ROUTE_NAME,
                    );
                  }),
                  Btn(localizations.locationUpdatesExWithCallback, () {
                    Navigator.pushNamed(
                      context,
                      LocationUpdatesExCbScreen.ROUTE_NAME,
                    );
                  }),
                  Btn(localizations.locationEnhanceService, () {
                    Navigator.pushNamed(
                      context,
                  ...
                  CRow(
                    children: <Widget>[
                      Btn(localizations.enableBgLocation, _enableBackgroundLocation),
                      Btn(localizations.disableBgLocation, _disableBackgroundLocation),
                    ],
                  ),
                  CRow(
                    children: <Widget>[
                      Btn(localizations.setLogConfig, _setLogConfig),
                      Btn(localizations.getLogConfig, _getLogConfig),
                    ],
                  ),
                  Container(
