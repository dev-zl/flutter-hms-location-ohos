...
class _HighPrecisionLocationScreenState
  ...
  void _onCallbackResult(LocationResult result) {
    print('[HighPrecisionLocationScreen] _onCallbackResult called with: $result');
    _appendToBottomText(result.toString());
    print('[HighPrecisionLocationScreen] _appendToBottomText completed');
  }

  void _onLocationAvailability(LocationAvailability result) {
    print('[HighPrecisionLocationScreen] _onLocationAvailability called with: $result');
    _appendToBottomText(result.toString());
    print('[HighPrecisionLocationScreen] _appendToBottomText completed');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(localizations.highPrecisionLocationService),
      ),
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Btn(localizations.requestHighPrecisionLocation, _reqHighPrecisionLoc),
            Btn(localizations.removeHighPrecisionLocation, _removeHighPrecisionLoc),
            Expanded(
