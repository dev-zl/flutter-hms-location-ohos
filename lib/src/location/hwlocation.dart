...
class HWLocation {
  ...
  factory HWLocation.fromMap(Map<dynamic, dynamic>? map) {
    return HWLocation(
      ...
      horizontalAccuracyMeters: map?['horizontalAccuracyMeters']?.toDouble(),
      verticalAccuracyMeters: map?['verticalAccuracyMeters']?.toDouble(),
      speedAccuracyMetersPerSecond: map?['speedAccuracyMetersPerSecond']?.toDouble(),
      bearingAccuracyDegrees: map?['bearingAccuracyDegrees']?.toDouble(),
      time: map?['time'],
      elapsedRealtimeNanos: map?['elapsedRealtimeNanos'].toInt(),
